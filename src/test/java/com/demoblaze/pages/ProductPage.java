...
public class ProductPage extends BasePage{
    ...
    public void addPrudoct_mtd(String product, String category){
        ...
        BrowserUtils.waitForClickablility(productItem,5).click(); // akıllı bekleme loc bulana kadar bekler bulduğunda devam eder
