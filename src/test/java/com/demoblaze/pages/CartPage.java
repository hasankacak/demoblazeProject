...
public class CartPage extends BasePage{
    ...
    public void removeProduct_mtd(String product){
        BrowserUtils.waitForClickablility(cartLink_loc,3).click();
    ...
    public void finishPurchase_logAmount_mtd(){
        ...
        String [] confitmationArray=confirmationMessage.split("\n");

        actualAmount = Integer.parseInt(confitmationArray[1].split(" ")[1]);
        BrowserUtils.waitFor(2);
        ok_loc.click();
    }
